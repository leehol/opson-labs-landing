        ...
        <div className="px-4 sm:px-6">
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <div className="relative">
                        <div
                          className="absolute inset-y-0 left-0 text-gray-500/70 dark:text-gray-400/70 pl-4 flex items-center pointer-events-none">
                          <svg
          ...
          <div className="max-w-xs md:max-w-6xl mx-auto">
            <div className="grid md:grid-cols-3 gap-6 xl:gap-9 xl:mx-8 max-md:-mx-3">
              {/* Card */}
              <div
                className="flex flex-col rounded-lg bg-gradient-to-tr from-white/70 to-white/50 dark:bg-gradient-to-b dark:from-gray-700/50 dark:to-gray-700/40 p-5">
              ...
              <div className="flex flex-col rounded-lg bg-gradient-to-tr from-white/70 to-white/50 dark:bg-gradient-to-b dark:from-gray-700/50 dark:to-gray-700/40 p-5">
                <div className="grow mb-3">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-500">
                    Prefer to visit? We're located in San Francisco, California.
                  </p>
                </div>
                <div className="flex items-center space-x-2.5">
                  <svg
